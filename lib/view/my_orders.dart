...
class _CartScreenState extends State<MyOrders> {
  ...
  getCategoriesData() async {
    ...
    var res = await Network().postData(data, '${AppUrls.baseUrl}/api/getAllOrders');
    print(res.body);
    ...
    if (json.decode(res.body)['myOrders'] != null) {

      myOrders=json.decode(res.body)['myOrders'];
              ...
              child: myOrders.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  onTap: (){
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) =>  MyExersice(calories: item['calaries'],)),
                    );
                  },
                    child: OrderItemWidget(
                    imageUrl: item['vendor_image'],
                    name:  item['Username'],
                    price: item['amount'], calorie: item['calaries'],
                  ));
                },
              ),),
            // List of items
